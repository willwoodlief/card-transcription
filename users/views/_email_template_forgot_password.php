...
<html>
  ...
  <body>
    ...
    <p><a clicktracking=off href="<?php echo $results->verify_url."users/forgot_password_reset.php?email=".urlencode($email)."&vericode=$vericode&reset=1"; ?>">Reset Password</a></p>
    <p>Sincerely,</p>
    <p>-The Team-</p>
  </body>
</html>
